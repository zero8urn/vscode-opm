...
This document explains recommended patterns for implementing commands in a VS Code extension. It covers contribution points, registration, small-command design, composition with the `Container` service locator, testing, telemetry, and best practices.
...
- Use categories to group commands in the Command Palette (e.g., `ListTask`, `MyExtension`).
