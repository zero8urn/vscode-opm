...
This document summarizes the high-level code layout and architecture so you can extract a compact, production-ready layout for a new VS Code extension. It focuses on responsibilities, key files, and where to place new extension code.
...
Created as a compact, actionable repository structure to help you extract and reuse the architecture for a smaller extension.
