...
This document explains how to implement Tree Views and related view patterns in a VS Code extension, following the conventions used by GitLens. It covers `TreeDataProvider` implementation, node models, refresh/reveal strategies, view registration, and performance considerations.
