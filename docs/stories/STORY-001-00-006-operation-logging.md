# STORY-001-00-006-operation-logging
...
**I want** operation logging & cli error mapping  
...
### Key Components
- **File/Module**: `src/env/node/dotnetExecutor.ts` - Implementation component
- **File/Module**: `src/commands/*` - Implementation component
...
---
**Story ID**: STORY-001-00-006-operation-logging  
**Feature**: [FEAT-001-00-foundations](../features/FEAT-001-00-foundations.md)  
**Epic**: [EPIC-001-nuget-package-management](../epics/EPIC-001-nuget-package-management.md)
