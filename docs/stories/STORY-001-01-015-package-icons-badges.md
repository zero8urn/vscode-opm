# STORY-001-01-015-package-icons-badges
...
**I want** add package icons and badges  
...
### Key Components
- **File/Module**: `src/webviews/apps/components/package-card.ts` - Implementation component
...
---
**Story ID**: STORY-001-01-015-package-icons-badges  
**Feature**: [FEAT-001-01-browse-search](../features/FEAT-001-01-browse-search.md)  
**Epic**: [EPIC-001-nuget-package-management](../epics/EPIC-001-nuget-package-management.md)
