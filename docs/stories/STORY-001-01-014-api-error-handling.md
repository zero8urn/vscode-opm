# STORY-001-01-014-api-error-handling
...
**I want** handle api errors in webview  
...
### Key Components
- **File/Module**: `src/webviews/apps/components/error-state.ts` - Implementation component
...
---
**Story ID**: STORY-001-01-014-api-error-handling  
**Feature**: [FEAT-001-01-browse-search](../features/FEAT-001-01-browse-search.md)  
**Epic**: [EPIC-001-nuget-package-management](../epics/EPIC-001-nuget-package-management.md)
