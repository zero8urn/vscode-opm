...
This document explains best practices and implementation details for Webviews in VS Code extensions, aligned with the GitLens architecture. It focuses on lifecycle, bundling, security, communication (IPC), and using Lit for structured UI.
